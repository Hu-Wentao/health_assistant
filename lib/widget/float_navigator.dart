...
class _FloatNavigatorState extends State<FloatNavigator>
  ...
  List _items = [Icons.assignment, Icons.all_inclusive, Icons.person]; //导航项
  ...
  Widget build(BuildContext context) {
    ...
    double singleWidth = width / _items.length;
    return Container(
                ...
                Positioned(
                  ...
                  child: DecoratedBox(
                    ...
                    child: CircleAvatar(
                        ...
                        child: Icon(_items[_activeIndex],
